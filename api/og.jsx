  ...
  return new ImageResponse(
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 126, fontWeight: 900, letterSpacing: '-0.07em', lineHeight: 0.9 }}>
            {hero}
          </div>
          <div style={{ fontSize: 28, color: targetComplete || portableReady ? '#68d391' : '#9aa6b2', marginTop: 14 }}>
            {heroLabel}
          </div>
        </div>
